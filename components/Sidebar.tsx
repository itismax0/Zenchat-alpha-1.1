...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="px-4 py-4 flex items-center justify-between border-b border-gray-50 dark:border-slate-700 bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm sticky top-0 z-10">
        ...
        <div className="flex gap-2">
              ...
              {showCreateMenu && (
                <div className="absolute top-full right-0 mt-2 w-56 bg-white dark:bg-slate-800 rounded-xl shadow-xl border border-gray-100 dark:border-slate-700 py-2 z-50 animate-dropdown origin-top-right">
                  <button 
                    ...
                    className="w-full text-left px-4 py-3 flex items-center gap-3 hover:bg-gray-50 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 transition-colors active:scale-95 duration-100"
                  >
            ...
            <button 
                ...
                className="p-2 text-gray-400 hover:text-slate-600 dark:hover:text-slate-300 transition-colors rounded-full hover:bg-gray-50 dark:hover:bg-slate-700 btn-press"
            >
                <Settings size={18} />
            </button>
        </div>
      ...
      <div className="px-4 py-3">
        <div className="relative group">
          ...
          <input
            ...
            className="w-full bg-gray-100 dark:bg-slate-700 text-base text-slate-800 dark:text-white placeholder-gray-500 rounded-full pl-10 pr-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-100 dark:focus:ring-slate-600 focus:bg-white dark:focus:bg-slate-600 input-transition"
          />
        </div>
      </div>
          ...
          >
            ...
            <div className="ml-3 flex-1 min-w-0">
              <div className="flex justify-between items-baseline mb-0.5">
                <h3 className={`text-sm font-medium truncate flex items-center gap-1 transition-colors ${activeContactId === contact.id ? 'text-blue-900 dark:text-blue-300' : 'text-slate-800 dark:text-white'}`}>
